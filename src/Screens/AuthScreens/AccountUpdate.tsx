  ...
  const userMe = async () => {
    ...
    await fetch(`${url}/user/me/${userDatax?.data?._id}`, {
      ...
      .then((res2) => {
        setLoadx(false);
        if (res2.success) {
          setFullName(res2?.personal_info?.name);
          setCountry(res2?.personal_info?.country);
          setState(res2?.personal_info?.state);
          setCity(res2?.personal_info?.city);
          setGender(res2?.personal_info?.gender);
          setUserId(res2?.personal_info?._id);
          setPhoneNumber(res2?.personal_info?.phoneNumber);
          setDate(res2?.personal_info?.date_of_birth);
          setImage(res2?.personal_info?.profileImage);
          setCloudImageUrl(res2?.personal_info?.profileImage);
          setData(res2);
        } else {
          alert(res2.errors);
        }
