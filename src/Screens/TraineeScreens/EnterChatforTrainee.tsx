...
const EnterChatforTrainee = ({ navigation }) => {
  ...
  const getUserInfo = async () => {
    ...
    setTraineeId(userDatax?.data?._id);
  };
            ...
            >
              ...
              >
                <Image
                  ...
                  source={{
                    uri: `${route.params.receiverImage}`,
                  }}
                />
              </View>
              <View style={{ width: "60%" }}>
...
export default EnterChatforTrainee;
