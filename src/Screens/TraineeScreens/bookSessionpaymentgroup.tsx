...
const BookSessionPaymentgroup = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.fixeheight1}>
          <View style={styles.TopView}>
            <View style={styles.topView}>
              ...
              <Text style={styles.beforclasstextstyle}>Pay before the class starts</Text>
            </View>
          </View>
        </View>
      </View>
            ...
            <View style={styles.marchmainview2}>
              ...
              >
                ...
                >
                  ...
                  <AntDesign onPress={() => setDetails(!details)} name={details ? "up" : "down"} size={15} color={"#fff"} />
                </View>
              </Pressable>
            </View>
            {/*end Yoga */}
              ...
              <View style={{ width: "100%", paddingBottom: 18 }}>
                <View style={{ width: "90%" }}>
                  ...
                  <View style={styles.dotmainview}>
                    ...
                    <View style={{ width: "90%" }}>
                      <Text style={styles.textstyle}>Trainer name: Murrey Job{"\n"}Trainer name: Murrey Job</Text>
                    </View>
                  </View>
                  <View style={styles.dotmainview}>
                    <View style={styles.dotview}>
                    ...
                    <View style={{ width: "90%" }}>
                      <Text style={styles.textstyle}>Location{"\n"}133, Aviar Street</Text>
                    </View>
                  </View>
                  <View style={styles.dotmainview}>
                    <View style={styles.dotview}>
                    ...
                    <View style={{ width: "90%" }}>
                      <Text style={styles.textstyle}>Description:{"\n"}Lorem ipsum dolor sit amet, consectetur adipiscing elit. In adipiscing ac adipiscing mauris tincidunt varius sollicitudin.</Text>
                    </View>
                  </View>
                </View>
              </View>
      ...
      <View style={styles.footer}>
        <View style={styles.TopView}>
          <Button navigation={navigation} label={"Pay Now"} onPress={NextScreen} />
        </View>
      </View>
    </View>
  );
...
export default BookSessionPaymentgroup;
