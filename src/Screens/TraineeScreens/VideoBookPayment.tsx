          ...
          <View style={styles.topView}>
            ...
            <View style={styles.BoxView}>
              ...
              <View style={styles.rowboxmainview}>
                <View style={styles.boxviewicon}></View>
                <View style={{ width: "90%" }}>
                  <Text style={styles.boxtextstyle}>Learn Advance technique</Text>
                </View>
              </View>
              {/*start */}
              <View style={styles.rowboxmainview}>
              ...
              <View style={styles.rowboxmainview}>
                <View style={styles.boxviewicon}></View>
                <View style={{ width: "90%" }}>
                  <Text style={styles.boxtextstyle}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In adipiscing ac adipiscing mauris tincidunt varius sollicitudin. </Text>
                </View>
              </View>
            </View>
          </View>
