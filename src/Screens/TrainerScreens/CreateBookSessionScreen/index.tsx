        ...
        <View style={styles.mainBody}>
            ...
            <View style={styles.titleRightColRect}>
              <TouchableOpacity
                ...
                <View
                  ...
                  <Text style={styles.tapSelectTitle}>
                    {time === '00:00 PM'
                      ? '00:00 PM'
          ...
          <View style={styles.mainBoxView}>
            ...
            <View style={styles.boxViews2}>
              <Pressable
                style={
                  noEquipment ? styles.boxShadowborder : styles.boxShadowView
                }
                onPress={() => {
                  setCardio(false);
                  setNoEquipment(true);
        ...
        <View style={styles.mainbtnView}>
          <Pressable
            ...
            style={[
              ...
              !slots === 0 ||
              !price
                ? styles.profileDisablebtnview
                : styles.profilebtnview,
            ]}>
            {load === true ? (
